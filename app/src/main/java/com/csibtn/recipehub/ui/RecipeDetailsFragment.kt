...
class RecipeDetailsFragment : Fragment() {
    ...
    private fun setUpView() {
        ...
        recipeDetailsBinding.recipeLinkTV.text =
            Html.fromHtml(recipeLink, HtmlCompat.FROM_HTML_MODE_COMPACT)
        recipeDetailsBinding.recipeLinkTV.movementMethod = LinkMovementMethod.getInstance()
        recipeDetailsBinding.summaryTV.text =
            Html.fromHtml(recipeArg.recipe.summary, HtmlCompat.FROM_HTML_MODE_COMPACT)
